...
io.sockets.on('connection', function(socket) {
    ...
    //logger.emit('newEvent', 'userConnected', {'socket':socket.id, 'channel ':room, 'user: ':username});
    ...
    socket.emit('connected', data.channel);
   // console.log('channel: '+ data.channel,'user: '+ data.user);
    ...
    //socket.emit('subscriptionConfirmed', {'room': n.channel});
   ...
   */
    ...
    */
    ...
    socket.on('disconnect', function() {
        ...
        db.hgetall(socket.id, function(err, obj) {
          //  if (err) return logger.emit('newEvent', 'error', err);
            //logger.emit('newEvent', 'userDisconnected', {'socket':socket.id, 'username':obj.username, 'room':room});
